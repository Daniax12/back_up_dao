...
public class SqlScriptUtil {
    ...
    public static String sqlScriptSelectingTableOrder(String nameTable, List<Field> allFields, List<Field> fields, Object object, String nameAttribute, Ordering ordering) throws Exception{
        
        try {
            String find = sqlScriptSelectingTable(nameTable, fields, object);
            Integer index = null;
     ...
     * @throws Exception 
     */
    public static String sqlScriptSelectingTable(String nameTable, List<Field> fields, Object object) throws Exception{
        String mainRequest = "SELECT * FROM %s ";
        
        try {
            if(nameTable == null) nameTable = SqlScriptUtil.myTableName(object); // Get the name of the table   
